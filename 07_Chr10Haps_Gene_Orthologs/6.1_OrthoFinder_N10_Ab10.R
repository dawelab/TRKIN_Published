...
pdf(file="N10_Ab10_Orthologes_KaryoploteR.pdf", width = 6, height = 4, bg = "white")
kp <- plotKaryotype(genome = Ab10.genome, chromosomes = c("Ab10", "N10"), plot.type=1, plot.params=pp)
kpRect(kp, chr="N10", x0=141187279, x1=152435371, y0=-0.25, y1=-0.35, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=141115174, x1=142472000, y0=0.01, y1=0.1, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=152050000, x1=156880000, y0=0.01, y1=0.1, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=158250000, x1=167721000, y0=0.01, y1=0.1, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=142472000, x1=146699300, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=150656000, x1=153145000, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=157485200, x1=159356550, y0=0.01, y1=0.1, col = "deepskyblue",  border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=174433450, x1=182846100, y0=0.01, y1=0.1, col = "darkorange3", border= "darkorange3")
...
kpRect(kp, chr="Ab10", x0=189326066, x1=190330226, y0=0.01, y1=0.1, col = "hotpink", border = "hotpink")
