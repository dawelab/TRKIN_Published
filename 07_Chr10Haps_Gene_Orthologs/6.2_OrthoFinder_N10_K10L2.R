...
#I took these files and ran them with bedtools intersect to find gene exons overlapping with annotated TEs so that I can filter them out. This script is not shown, though it is very simple. 
...
#Select only K10L2 and Ab10 from the genome file, mine also had N10 for simplicity
...
#This defines the known regions for plotting. Separating them like this allows me to color them differently
...
pdf(file="K10L2_Ab10_Orthologes_KaryoploteR.pdf",  width = 6, height = 4, bg = "white")
kp <- plotKaryotype(genome = Ab10.genome, chromosomes = c("K10L2","Ab10"), plot.type=1, plot.params=pp)
kpRect(kp, chr="K10L2", x0=7429619, x1=13957822, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="K10L2", x0=15726572, x1=15898240, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="K10L2", x0=16787371, x1=25024178, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="K10L2", x0=25498094, x1=25502283, y0=0.01, y1=0.1, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="K10L2", x0=16328801, x1=16357145, y0=0.01, y1=0.1, col = "blue", border= "blue")
kpRect(kp, chr="K10L2", x0=2729416, x1=7429619, y0=0.01, y1=0.1, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="K10L2", x0=25502283, x1=31891546, y0=0.01, y1=0.1, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=141115174, x1=142472000, y0=-0.25, y1=-0.35, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=152050000, x1=156880000, y0=-0.25, y1=-0.35, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=158250000, x1=167721000, y0=-0.25, y1=-0.35, col = "darkgoldenrod1", border= "darkgoldenrod1")
kpRect(kp, chr="Ab10", x0=142472000, x1=146699300, y0=-0.25, y1=-0.35, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=150656000, x1=153145000, y0=-0.25, y1=-0.35, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=157485200, x1=159356550, y0=-0.25, y1=-0.35, col = "deepskyblue", border= "deepskyblue")
kpRect(kp, chr="Ab10", x0=174433450, x1=182846100, y0=-0.25, y1=-0.35, col = "darkorange3", border= "darkorange3")
...
kpRect(kp, chr="Ab10", x0=189326066, x1=190330226, y0=-0.25, y1=-0.35, col = "hotpink", border = "hotpink")
