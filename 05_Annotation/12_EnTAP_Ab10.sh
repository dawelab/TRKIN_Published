...
EnTAP --config --ini /path/to/entap_config.ini -i $OUTDIR/AGAT/B73_Ab10_HiFi_v2.cds.fasta -d $OUTDIR/Entap/uniprot_sprot.fasta -d $OUTDIR/Entap/RefSeq.plant.protein.faa -d $OUTDIR//Entap/nr.fasta --overwrite
...
EnTAP --runP --ini /path/to/entap_config.ini -i $OUTDIR/AGAT/B73_Ab10_HiFi_v2.cds.fasta -d $OUTDIR/Entap/K10L2/entap_outfiles/bin/uniprot_sprot.dmnd -d /$OUTDIR/Entap/K10L2/entap_outfiles/bin/RefSeq.dmnd -d $OUTDIR/Entap/K10L2/entap_outfiles/bin/nr.dmnd  --out-dir /$OUTDIR/Entap/Ab10/entap_outfiles_v2 -t 24
