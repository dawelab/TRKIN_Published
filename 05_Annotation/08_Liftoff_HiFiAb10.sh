...
bedtools intersect -a $OUTDIR/Pasa_Ab10/PASA_updates.3.gff3 -b $DIR/B73_Ab10_HiFi_v2.trkinreg.fa -o $DIR/Pasa_Ab10/PASA_updates.3.trkinreg.gff3 
...
cat $DIR/B73_Ab10_HiFi_v2.trkinreg.K10L2liftoff.newonly.fix.gff3 $OUTDIR/Pasa_Ab10/PASA_updates.3.gff3 > $DIR/B73_Ab10_HiFi_v2.gene.gff3
