...
featureCounts(files, annot.ext="Zm-B73_AB10-REFERENCE-NAM-1.0_Zm00043a.1.gtf", isGTFAnnotationFile=TRUE, isPairedEnd=TRUE, minMQS=20, countMultiMappingReads=FALSE, largestOverlap=TRUE, nthreads=12)
